...
var $author$project$Route$RouteWaiver = function (a) {
	return {$: 'RouteWaiver', a: a};
};
...
var $author$project$Route$matchRoute = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Route$RouteHome, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$RouteWaiver,
			A2(
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$RouteAdmin,
			$elm$url$Url$Parser$s('admin')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$RouteAdminProjects,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('admin'),
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$RouteAdminProjectDetail,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('admin'),
				A2(
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$RouteAdminSignatures,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('admin'),
				$elm$url$Url$Parser$s('signatures'))),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Route$RouteSignatureStatus,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('signatures'),
				$elm$url$Url$Parser$string))
...
var $author$project$Page$Waiver$init = function (slug) {
	return _Utils_Tuple2(
		{email: '', error: $elm$core$Maybe$Nothing, firstName: '', isSubmitting: false, lastName: '', phone: '', slug: slug},
	...
	function (flags, url, key) {
		...
		var _v0 = function () {
			if ((route.$ === 'Just') && (route.a.$ === 'RouteWaiver')) {
				var slug = route.a.a;
				var _v2 = $author$project$Page$Waiver$init(slug);
				var waiverModel = _v2.a;
				var waiverCmd = _v2.b;
				return _Utils_Tuple2(
					$elm$core$Maybe$Just(waiverModel),
					A2($elm$core$Platform$Cmd$map, $author$project$Main$PageWaiverMsg, waiverCmd));
			} else {
...
var $author$project$Generated$IoBryzekWaiversApi$Signature = F6(
	function (id, user, waiver, status, signedAt, signnowUrl) {
		return {id: id, signedAt: signedAt, signnowUrl: signnowUrl, status: status, user: user, waiver: waiver};
	});
...
var $author$project$Generated$IoBryzekWaiversApi$SignatureStatusSigned = {$: 'SignatureStatusSigned'};
var $author$project$Generated$IoBryzekWaiversApi$SignatureStatusUnknown = {$: 'SignatureStatusUnknown'};
var $author$project$Generated$IoBryzekWaiversApi$signatureStatusFromString = function (value) {
	return (value === 'pending') ? $author$project$Generated$IoBryzekWaiversApi$SignatureStatusPending : ((value === 'signed') ? $author$project$Generated$IoBryzekWaiversApi$SignatureStatusSigned : ((value === 'expired') ? $author$project$Generated$IoBryzekWaiversApi$SignatureStatusExpired : ((value === 'cancelled') ? $author$project$Generated$IoBryzekWaiversApi$SignatureStatusCancelled : $author$project$Generated$IoBryzekWaiversApi$SignatureStatusUnknown)));
};
var $author$project$Generated$IoBryzekWaiversApi$signatureStatusDecoder = A2($elm$json$Json$Decode$map, $author$project$Generated$IoBryzekWaiversApi$signatureStatusFromString, $elm$json$Json$Decode$string);
var $author$project$Generated$IoBryzekWaiversApi$User = F5(
	function (id, email, firstName, lastName, phone) {
		return {email: email, firstName: firstName, id: id, lastName: lastName, phone: phone};
	});
var $author$project$Generated$IoBryzekWaiversApi$userDecoder = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'phone',
	$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string),
	$elm$core$Maybe$Nothing,
		...
		A3(
			...
			A3(
				...
				A3(
					...
					'id',
					$elm$json$Json$Decode$string,
					$elm$json$Json$Decode$succeed($author$project$Generated$IoBryzekWaiversApi$User))))));
var $author$project$Generated$IoBryzekWaiversApi$Waiver = F6(
	function (id, projectId, version, title, content, isCurrent) {
		return {content: content, id: id, isCurrent: isCurrent, projectId: projectId, title: title, version: version};
	});
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Generated$IoBryzekWaiversApi$waiverDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'is_current',
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'id',
						$elm$json$Json$Decode$string,
						$elm$json$Json$Decode$succeed($author$project$Generated$IoBryzekWaiversApi$Waiver)))))));
var $author$project$Generated$IoBryzekWaiversApi$signatureDecoder = A4(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$optional,
	'signnow_url',
	$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string),
	$elm$core$Maybe$Nothing,
	A4(
		...
		A3(
			$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'status',
			$author$project$Generated$IoBryzekWaiversApi$signatureStatusDecoder,
			A3(
				$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'waiver',
				$author$project$Generated$IoBryzekWaiversApi$waiverDecoder,
				A3(
					$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
					'user',
					$author$project$Generated$IoBryzekWaiversApi$userDecoder,
					A3(
						$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
						'id',
						$elm$json$Json$Decode$string,
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'first_name',
				$elm$json$Json$Encode$string(instance.firstName)),
				_Utils_Tuple2(
				'last_name',
				$elm$json$Json$Encode$string(instance.lastName)),
				_Utils_Tuple2(
				'email',
				$elm$json$Json$Encode$string(instance.email)),
				_Utils_Tuple2(
				'phone',
				A2($author$project$Generated$IoBryzekWaiversApi$encodeOptional, $elm$json$Json$Encode$string, instance.phone))
			]));
};
		...
		return $elm$http$Http$request(
			{
				body: $elm$http$Http$jsonBody(
					$author$project$Generated$IoBryzekWaiversApi$waiverFormEncoder(waiverForm)),
				expect: A2($author$project$Generated$ApiRequest$expectJson, $author$project$Page$Waiver$SignatureResponse, $author$project$Generated$IoBryzekWaiversApi$signatureDecoder),
...
var $author$project$Page$Waiver$update = F2(
	function (msg, model) {
		switch (msg.$) {
					...
					if (_v2.$ === 'Just') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{isSubmitting: false}),
							$author$project$Ports$redirectToExternalUrl(url));
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									error: $elm$core$Maybe$Just('No signature URL received'),
									isSubmitting: false
								}),
							$elm$core$Platform$Cmd$none);
					}
						...
						_Utils_update(
							model,
							{
								error: $elm$core$Maybe$Just(
									$author$project$Page$Waiver$apiErrorToString(error)),
								isSubmitting: false
							}),
						$elm$core$Platform$Cmd$none);
				}
		...
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				var _v3 = function () {
					if ((route.$ === 'Just') && (route.a.$ === 'RouteWaiver')) {
						var slug = route.a.a;
						var _v5 = $author$project$Page$Waiver$init(slug);
						var waiverModel = _v5.a;
						var waiverCmd = _v5.b;
						return _Utils_Tuple2(
							$elm$core$Maybe$Just(waiverModel),
							A2($elm$core$Platform$Cmd$map, $author$project$Main$PageWaiverMsg, waiverCmd));
...
var $author$project$Templates$Shell$viewHeader = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('bg-white shadow-sm border-b border-gray-200')
		]),
	_List_fromArray(
		[
			A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('text-xl font-semibold text-gray-900')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													...
													$elm$html$Html$Attributes$class('hover:text-blue-600')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text('Waivers')
												]))
										]))
								])),
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('flex items-center space-x-6')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$class('text-gray-600 hover:text-gray-900')
										]),
									_List_fromArray(
										[
...
var $author$project$Templates$Shell$view = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Templates$Shell$viewHeader,
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$class('w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500')
			]),
		_List_Nil);
};
	...
	function (maybeRoute, pageWaiverModel) {
		if (maybeRoute.$ === 'Nothing') {
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('mt-4 text-gray-600')
							]),
						_List_fromArray(
							[
			...
			switch (route.$) {
				...
				case 'RouteAdminProjectDetail':
					var projectId = route.a;
					return A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Project: ' + projectId)
									]))
							]));
				case 'RouteAdminSignatures':
					return A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Signature Status: ' + signatureId)
									]))
							]));
			}
		}
