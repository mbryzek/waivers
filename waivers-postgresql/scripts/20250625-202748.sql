...
create table signatures(
  ...
  person_first_name   text not null check(util.non_empty_trimmed_string(person_first_name)),
  person_last_name    text not null check(util.non_empty_trimmed_string(person_last_name)),
  person_email        text not null check(util.non_empty_trimmed_string(person_email)),
  person_phone        text check(util.null_or_non_empty_trimmed_string(person_phone)),
